...
public class EventTestSamples {
    ...
    public static Event getEventSample1() {
        return new Event().id(1L).event_location("event_location1").event_description("event_description1");
    }

    public static Event getEventSample2() {
        return new Event().id(2L).event_location("event_location2").event_description("event_description2");
    }
